...
var LOPEZ *SoundCollection = &SoundCollection{
	Prefix: 	"lopez",
	ChainWith: LOPEZ,
	Commands: []string{
		"!lopez",
	...
	Sounds: []*Sound{
		createSound("devosmorts", 1, 250),
		createSound("enculer", 1, 250),
		createSound("gne", 1, 250),
		createSound("tafemme", 1, 250),
		createSound("tg", 1, 250),
		createSound("toutseul", 1, 250),
		createSound("viensla", 1, 250),
	},
}
...
func onGuildCreate(s *discordgo.Session, event *discordgo.GuildCreate) {
	...
	for _, channel := range event.Guild.Channels {
		if channel.ID == event.Guild.ID {
			s.ChannelMessageSend(channel.ID, "**LOPEZ DE VOS MORTS ! Tapez !LOPEZ pour invoquer les lopez !**")
			return
		}
	}
}
